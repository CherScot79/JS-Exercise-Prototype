...
function Airplane(name) {
 ...
 function Person(name, age) {
  ...
  const weirdTeen = new Person("Jayme", 13);

 
  
  console.log(weirdTeen.toString());

  
  weirdTeen.eat("pineapple");
  weirdTeen.eat("snails");
  weirdTeen.eat("club sandwich");
  
  console.log(weirdTeen.stomach);
...
Baby.prototype.play = function() {
  ...
  const loki = new Baby("Loki", 1, "stuffie");
  
  console.log(loki.play());
